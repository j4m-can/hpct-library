...
Update charm yaml files from the hpctlib:
/home/jdm/projects/canonical/projects/juju/dev/hpct-library/git/share/hpctlib/DebuggerCharm
1) add contents of share/hpctlib/DebuggerCharm/action.yaml to action.yaml
2) add contents of share/hpctlib/DebuggerCharm/config.yaml to config.yaml
"""
